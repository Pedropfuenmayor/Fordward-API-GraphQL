...
module.exports = {
  Query: {
    ...
    project: async function (_, { project_id }) {
    ...
    challenges: async function (_, { project_id }) {
    ...
    challenge: async function (_, { project_id, challenge_id }) {
    ...
    chosenChallenges: async function (_, { project_id }) {
    ...
    ideas: async function (_,{ project_id, challenge_id }) {
      ...
      idea: async function (_,{ project_id, challenge_id, idea_id }) {
      ...
      chosenIdeas: async function (_,{ project_id, challenge_id }) {
      ...
      action: async function (_,{ project_id, challenge_id, idea_id }) {
  ...
  Mutation: {
    createUser: async function (_, { createUserInput }) {
    ...
    deleteUser: async function (_, { user_id }) {
    ...
    createProject: async function (_,{ createProjectInput }) {
      ...
      updateProject: async function (_,{ project_id, project_name }) {
        const errors = [];
        if (validator.isEmpty(project_name.trim())) {
          errors.push({ message: "Project name must not be empty!" });
        }
      ...
      deleteProject: async function (_,{ project_id }) {
      ...
      createChallenge: async function (_,{ createChallengeInput }) {
      ...
      selectChallenges: async function (_,{ selectedIds, project_id }) {
      ...
      updateChallenge: async function (_,{ challenge_id, challenge_name }) {
        const errors = [];
        if (validator.isEmpty(challenge_name.trim())) {
          errors.push({ message: "Challenge name must not be empty!" });
        }
      ...
      deleteChallenge: async function (_,{ challenge_id }) {
      ...
      createOQ: async function (_,{ challenge_id, oq_id, oq_name }) {
        const errors = [];
      ...
      updateOQ: async function (_,{ oq_id, oq_name }) {
        const errors = [];
        if (validator.isEmpty(oq_name.trim())) {
          errors.push({ message: "OQ name must not be empty!" });
        }
      ...
      deleteOQ: async function (_,{ oq_id }) {
      ...
      createIdea: async function (_,{ challenge_id, idea_id, idea_name }) {
        const errors = [];
      ...
      selectIdeas: async function (_,{ selectedIds, challenge_id }) {
        const receivedIds = extractedIds(selectedIds);
        // refactor to handle error properly
      ...
      updateIdea: async function (_,{ idea_id, idea_name }) {
        const errors = [];
      ...
      updateIdeaImpactEffort: async function (_,
      ...
      deleteIdea: async function (_,{ idea_id }) {
      ...
      createAction: async function (_,{ createActionInput }) {
        const {
          action_id,
          action_what,
          action_due_date,
      ...
      updateAction: async function (_,{ updateActionInput }) {
        const {
          action_id,
          action_what,
          action_due_date,
      ...
      deleteAction: async function (_,{ action_id }) {
